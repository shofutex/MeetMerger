...
The input heat sheet should be structured as follows (PDF) or [using the sample data](https://github.com/shofutex/MeetMerger/blob/main/test-data/sample_heat_sheet.pdf). The second line is the team acronym, name, year, and time for a record-holder for the event.
